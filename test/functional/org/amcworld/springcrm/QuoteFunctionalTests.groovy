...
class QuoteFunctionalTests extends InvoicingTransactionTestCase {
    ...
    void deleteFixture() {
        ...
        quotes.each { it.delete(flush: true) }
    }
...
Die Einzelheiten wurden im Meeting am 21.01.2013 festgelegt.''')
        ...
        setInputValue('items[0].number', 'S-10000')
        setInputValue('items[0].quantity', '1')
        assert 'Einheiten' == selectAutocompleteEx('items[0].unit', 'Einh')
        setInputValue('items[0].name', 'Konzeption und Planung')
        setInputValue('items[0].description', 'Konzeption der geplanten Werbekampagne')
        setInputValue('items[0].unitPrice', '440')
        setInputValue('items[0].tax', '19')
        getInput('items[0].number').click()
        ...
        assert '526,26' == total
        setInputValue('items[1].quantity', '2')
        getInput('items[1].unitPrice').click()
        ...
        setInputValue('items[3].unitPrice', '3')
        getInput('items[3].name').click()
...
Die Einzelheiten wurden im Meeting am 21.01.2013 festgelegt.''' == getInputValue('headerText')
        ...
        setInputValue('items[0].unitPrice', '450')
        getInput('items[0].name').click()
        ...
        assert 3 == addNewPriceTableRow()
        openSelectorAndSelect 2, 'services', 'S-10700'
        checkRowValues 2, 'S-10700', '1', 'Stück', 'Stempel', 'Mit Firmenaufdruck nach Kundenvorgabe.', '8,99', '8,99', '19,0'
        setInputValue('items[3].quantity', 4)
        checkRowValues 2, 'S-10700', '4', 'Stück', 'Stempel', 'Mit Firmenaufdruck nach Kundenvorgabe.', '8,99', '35,96', '19,0'
        ...
        moveRowUp 2
        moveRowUp 1
        checkRowValues 0, 'S-10700', '4', 'Stück', 'Stempel', 'Mit Firmenaufdruck nach Kundenvorgabe.', '8,99', '35,96', '19,0'
        ...
        moveRowDown 0
        checkRowValues 0, 'S-10000', '1', 'Einheiten', 'Konzeption und Planung', 'Konzeption der geplanten Werbekampagne', '450,00', '450,00', '19,0'
        checkRowValues 1, 'S-10700', '4', 'Stück', 'Stempel', 'Mit Firmenaufdruck nach Kundenvorgabe.', '8,99', '35,96', '19,0'
        checkRowValues 2, 'P-10000', '2', 'Packung', 'Papier A4 80 g/m²', 'Packung zu 100 Blatt. Chlorfrei gebleicht.', '2,49', '4,98', '7,0'
        assert '490,94' == subtotalNet
        checkTaxRates([['7,0', '0,35'], ['19,0', '92,33']])
        assert '583,62' == subtotalGross
