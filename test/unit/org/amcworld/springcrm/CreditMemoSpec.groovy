...
class CreditMemoSpec extends Specification {
    ...
    def 'Compute turnover of products'() {
        ...
        when: 'I create a credit memo with a list of services'
        c = new CreditMemo(items: [
            new InvoicingItem(quantity: 0.5, unitPrice: 40.1, salesItem: new Service(type: 'S')),
            new InvoicingItem(quantity: 2, unitPrice: 0.75, salesItem: new Service(type: 'S')),
            new InvoicingItem(quantity: 4, unitPrice: 2.1, salesItem: new Service(type: 'S'))
        ])
        ...
        c = new CreditMemo(items: [
            new InvoicingItem(quantity: 0.5, unitPrice: 40.1, salesItem: new Product(type: 'P')),
            new InvoicingItem(quantity: 2, unitPrice: 0.75, salesItem: new Service(type: 'P')),
            new InvoicingItem(quantity: 4, unitPrice: 2.1, salesItem: new Product(type: 'P'))
        ])
    ...
    def 'Compute turnover of services'() {
        ...
        when: 'I create a credit memo with a list of some services'
        c = new CreditMemo(items: [
            new InvoicingItem(quantity: 0.5, unitPrice: 40.1, salesItem: new Service(type: 'S')),
            new InvoicingItem(quantity: 2, unitPrice: 0.75, salesItem: new Product(type: 'P')),
            new InvoicingItem(quantity: 4, unitPrice: 2.1, salesItem: new Service(type: 'S'))
    ...
    def 'Compute turnover of other items'() {
        ...
        when: 'I create a credit memo with a list of some products and services'
        c = new CreditMemo(items: [
            new InvoicingItem(quantity: 0.5, unitPrice: 40.1, salesItem: new Service(type: 'S')),
            new InvoicingItem(quantity: 2, unitPrice: 0.75, salesItem: new Product(type: 'P')),
            new InvoicingItem(quantity: 4, unitPrice: 2.1, salesItem: new Service(type: 'S'))
