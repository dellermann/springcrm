...
ExtDb = do ->
  ...
  rawExtensions =
    ...
    spreadsheet: '123 aws csv dfg dis edx edxz fcs fods gsheet gtable ks nam nb nmbtemplate numbers numbers-tef ods ots pmv qpw sdc stc sxc uos wki wks wku wq1 wq2 xl xlr xls xlsb xlshtml xlsm xlsmhtml xlsx xlthtml xltm xltx'
