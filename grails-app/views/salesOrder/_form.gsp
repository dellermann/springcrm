    ...
    <div class="col col-l">
      ...
      <div class="row">
        ...
        <div class="field${hasErrors(bean: salesOrderInstance, field: 'subject', ' error')}">
          <g:textField name="subject" value="${salesOrderInstance?.subject}" size="40" /><br />
      ...
      <div class="row">
        ...
        <div class="field${hasErrors(bean: salesOrderInstance, field: 'organization', ' error')}">
          <g:select name="organization.id" id="organization-sel" from="${org.amcworld.springcrm.Organization.list()}" optionKey="id" optionValue="shortName" value="${salesOrderInstance?.organization?.id}"  /><br />
...
var invoicingItems = new springcrm.InvoicingItems(
    "sales-order-items", "sales-order-form", "${resource(dir: 'img')}",
