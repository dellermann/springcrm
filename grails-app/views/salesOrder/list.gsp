    ...
    <table class="content-table">
      ...
      <g:each in="${salesOrderInstanceList}" status="i" var="salesOrderInstance">
        <tr>
          ...
          <td class="id sales-order-number"><g:link action="show" id="${salesOrderInstance.id}">${fieldValue(bean: salesOrderInstance, field: "fullNumber")}</g:link></td>
          <td class="string sales-order-subject"><g:link action="show" id="${salesOrderInstance.id}">${fieldValue(bean: salesOrderInstance, field: "subject")}</g:link></td>
          <td class="ref sales-order-organization"><g:link controller="organization" action="show" id="${salesOrderInstance.organization?.id}">${fieldValue(bean: salesOrderInstance, field: "organization")}</g:link></td>
