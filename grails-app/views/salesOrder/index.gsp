        ...
        <table class="table data-table">
          ...
          <tbody>
            <g:each in="${salesOrderInstanceList}" status="i" var="salesOrderInstance">
              <tr>
                <td class="col-type-id sales-order-number"><g:link action="show" id="${salesOrderInstance.id}"><g:fieldValue bean="${salesOrderInstance}" field="fullNumber" /></g:link></td>
                <td class="col-type-string sales-order-subject"><g:link action="show" id="${salesOrderInstance.id}"><g:nl2br value="${salesOrderInstance.subject}" /></g:link></td>
                <td class="col-type-ref sales-order-organization"><g:link controller="organization" action="show" id="${salesOrderInstance.organization?.id}"><g:fieldValue bean="${salesOrderInstance}" field="organization" /></g:link></td>
