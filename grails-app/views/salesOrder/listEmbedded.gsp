...
<table class="content-table">
  ...
  <g:each in="${salesOrderInstanceList}" status="i" var="salesOrderInstance">
    <tr>
      ...
      <td class="id sales-order-number"><g:link controller="salesOrder" action="show" id="${salesOrderInstance.id}">${fieldValue(bean: salesOrderInstance, field: "fullNumber")}</g:link></td>
      <td class="string sales-order-subject"><g:link controller="salesOrder" action="show" id="${salesOrderInstance.id}">${fieldValue(bean: salesOrderInstance, field: "subject")}</g:link></td>
