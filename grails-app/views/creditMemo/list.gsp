    ...
    <table class="content-table">
      ...
      <g:each in="${creditMemoInstanceList}" status="i" var="creditMemoInstance">
        <tr>
          ...
          <td class="id credit-memo-number"><g:link action="show" id="${creditMemoInstance.id}">${fieldValue(bean: creditMemoInstance, field: "fullNumber")}</g:link></td>
          <td class="string credit-memo-subject"><g:link action="show" id="${creditMemoInstance.id}">${fieldValue(bean: creditMemoInstance, field: "subject")}</g:link></td>
          <td class="ref credit-memo-organization"><g:link controller="organization" action="show" id="${creditMemoInstance.organization?.id}">${fieldValue(bean: creditMemoInstance, field: "organization")}</g:link></td>
