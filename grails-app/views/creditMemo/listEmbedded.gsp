    ...
    <g:each var="creditMemo" in="${creditMemoList}" status="i">
      <tr>
        <td class="col-type-id credit-memo-number">
          <g:link controller="creditMemo" action="show" id="${creditMemo.id}">
        ...
        <td class="col-type-currency credit-memo-total">
          <g:formatCurrency number="${creditMemo?.total}" displayZero="true"
            external="true"/>
        </td>
        <td class="col-type-currency credit-memo-closing-balance balance-state
            balance-state-${creditMemo?.balanceColor}">
        ...
        <td class="col-actions">
          ...
          <g:button controller="creditMemo" action="edit" id="${creditMemo.id}"
            color="success" size="xs" icon="pencil-square-o"
            message="default.button.edit.label"/>
          </g:if>
          <g:else>
          <g:button controller="creditMemo" action="editPayment"
            id="${creditMemo.id}" color="success" size="xs"
