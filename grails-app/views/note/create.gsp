...
<body>
  <div id="main-container-header">
    ...
    <nav id="toolbar-container">
      <ul id="toolbar">
        <li><a href="#" class="green" onclick="SPRINGCRM.submitForm('note-form'); return false;"><g:message code="default.button.save.label" /></a></li>
  ...
  <section id="content">
    ...
    <h3><g:message code="note.new.label" default="New ${entityName}" /></h3>
    <g:form name="note-form" action="save" params="[returnUrl:params.returnUrl]">
