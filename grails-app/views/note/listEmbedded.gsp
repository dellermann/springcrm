...
<table class="content-table">
  ...
  <g:each in="${noteInstanceList}" status="i" var="noteInstance">
    <tr>
      ...
      <td class="id note-number"><g:link controller="note" action="show" id="${noteInstance.id}">${fieldValue(bean: noteInstance, field: "fullNumber")}</g:link></td>
      <td class="string note-title"><g:link controller="note" action="show" id="${noteInstance.id}">${fieldValue(bean: noteInstance, field: "title")}</g:link></td>
