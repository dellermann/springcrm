...
<html>
  ...
  <body>
    <g:applyLayout name="list" model="[list: noteInstanceList]">
      ...
      <div class="table-responsive">
        <table class="table data-table">
          ...
          <tbody>
            ...
            <tr>
              <td class="col-type-id note-number"><g:link action="show" id="${noteInstance.id}"><g:fieldValue bean="${noteInstance}" field="fullNumber" /></g:link></td>
              <td class="col-type-string note-title"><g:link action="show" id="${noteInstance.id}"><g:fieldValue bean="${noteInstance}" field="title" /></g:link></td>
              <g:ifModuleAllowed modules="contact"><td class="col-type-ref note-organization"><g:link controller="organization" action="show" id="${noteInstance.organization?.id}"><g:fieldValue bean="${noteInstance}" field="organization" /></g:link></td></g:ifModuleAllowed>
              <g:ifModuleAllowed modules="contact"><td class="col-type-ref note-person"><g:link controller="person" action="show" id="${noteInstance.person?.id}"><g:fieldValue bean="${noteInstance}" field="person" /></g:link></td></g:ifModuleAllowed>
