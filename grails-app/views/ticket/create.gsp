...
<body>
  <div id="main-container-header">
    ...
    <nav id="toolbar-container">
      <ul id="toolbar">
        <li><a href="#" class="green submit-btn" data-form="ticket-form"><g:message code="default.button.save.label" /></a></li>
  ...
  <section id="content">
    ...
    <h3><g:message code="ticket.new.label" default="New ${entityName}" /></h3>
    <g:uploadForm name="ticket-form" action="save" params="[returnUrl: params.returnUrl]">
