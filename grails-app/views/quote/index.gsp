        ...
        <table class="table data-table">
          ...
          <tbody>
            ...
            <tr data-item-id="${quoteInstance.id}">
              <td class="col-type-id quote-number"><g:link action="show" id="${quoteInstance.id}"><g:fieldValue bean="${quoteInstance}" field="fullNumber" /></g:link></td>
              <td class="col-type-string quote-subject"><g:link action="show" id="${quoteInstance.id}"><g:nl2br value="${quoteInstance.subject}" /></g:link></td>
              <td class="col-type-ref quote-organization"><g:link controller="organization" action="show" id="${quoteInstance.organization?.id}"><g:fieldValue bean="${quoteInstance}" field="organization" /></g:link></td>
