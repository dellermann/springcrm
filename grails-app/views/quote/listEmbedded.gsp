...
<table class="content-table">
  ...
  <g:each in="${quoteInstanceList}" status="i" var="quoteInstance">
    <tr>
      ...
      <td class="id quote-number"><g:link controller="quote" action="show" id="${quoteInstance.id}">${fieldValue(bean: quoteInstance, field: "fullNumber")}</g:link></td>
      <td class="string quote-subject"><g:link controller="quote" action="show" id="${quoteInstance.id}">${fieldValue(bean: quoteInstance, field: "subject")}</g:link></td>
