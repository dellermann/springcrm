...
<body>
  <div id="main-container-header">
    ...
    <nav id="toolbar-container">
      <ul id="toolbar">
        <li><a href="#" class="green submit-btn" data-form="quote-form"><g:message code="default.button.save.label" /></a></li>
  ...
  <section id="content">
    ...
    <h3><g:message code="quote.new.label" default="New ${entityName}" /></h3>
    <g:form name="quote-form" action="save" params="[returnUrl: params.returnUrl]">
