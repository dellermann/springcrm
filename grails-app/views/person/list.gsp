    ...
    <table class="content-table">
      ...
      <g:each in="${personInstanceList}" status="i" var="personInstance">
        <tr>
          ...
          <td class="id person-number"><g:link action="show" id="${personInstance.id}">${fieldValue(bean: personInstance, field: "fullNumber")}</g:link></td>
          <td class="string person-last-name"><g:link action="show" id="${personInstance.id}">${fieldValue(bean: personInstance, field: "lastName")}</g:link></td>
          <td class="string person-first-name">${fieldValue(bean: personInstance, field: "firstName")}</td>
          <td class="ref person-organization"><g:link controller="organization" action="show" id="${personInstance.organization.id}">${fieldValue(bean: personInstance, field: "organization.name")}</g:link></td>
