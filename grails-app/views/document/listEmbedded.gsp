...
<table class="content-table">
  ...
  <g:each in="${documentInstanceList}" status="i" var="documentInstance">
    <tr>
      <td class="content-table-type-string content-table-column-document-name" headers="content-table-headers-document-name"><g:link controller="document" action="download" id="${documentInstance.id}" params="${[organization: organizationInstance.id]}" target="_blank">${fieldValue(bean: documentInstance, field: "name")}</g:link></td>
      ...
      <td class="content-table-buttons" headers="content-table-headers-document-buttons">
        <g:link controller="document" action="delete" id="${documentInstance.id}" params="${[organization: organizationInstance.id]}" class="button small red delete-btn"><g:message code="default.button.delete.label" /></g:link>
      </td>
    </tr>
  </g:each>
  </tbody>
