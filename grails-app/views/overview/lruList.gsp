<ol class="simple-ordered-list data-type-list">
  ...
  <li>
    ...
    <span class="item-actions">
      <g:link controller="${lruEntry.controller}" action="edit" id="${lruEntry.itemId}" params="[returnUrl: createLink(uri: '/', absolute: true)]" class="bubbling-icon"><i class="icon-edit"></i></g:link>
    </span>
  </li>
  </g:each>
</ol>
