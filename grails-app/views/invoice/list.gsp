    ...
    <table class="content-table">
      ...
      <g:each in="${invoiceInstanceList}" status="i" var="invoiceInstance">
        <tr>
          ...
          <td class="id invoice-number"><g:link action="show" id="${invoiceInstance.id}">${fieldValue(bean: invoiceInstance, field: "fullNumber")}</g:link></td>
          <td class="string invoice-subject"><g:link action="show" id="${invoiceInstance.id}">${fieldValue(bean: invoiceInstance, field: "subject")}</g:link></td>
          <td class="ref invoice-organization"><g:link controller="organization" action="show" id="${invoiceInstance.organization?.id}">${fieldValue(bean: invoiceInstance, field: "organization")}</g:link></td>
