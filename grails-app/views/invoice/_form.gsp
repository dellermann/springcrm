    ...
    <div class="col col-l">
      <div class="row">
        ...
        <div class="field${hasErrors(bean: invoiceInstance, field: 'number', ' error')}">
          <g:autoNumber prefix="${seqNumberPrefix}" suffix="${seqNumberSuffix}" value="${invoiceInstance?.number}" /><br />
    ...
    <div class="col col-r">
      <div class="row">
        ...
        <div class="field${hasErrors(bean: invoiceInstance, field: 'docDate', ' error')}">
          <g:dateInput name="docDate" value="${invoiceInstance?.docDate}" precision="day" /><br />
      ...
      <div class="row">
        ...
        <div class="field${hasErrors(bean: invoiceInstance, field: 'dueDatePayment', ' error')}">
          <g:dateInput name="dueDatePayment" value="${invoiceInstance?.dueDatePayment}" precision="day" /><br />
          <span class="info-msg"><g:message code="default.format.date.label" /></span>
...
<fieldset>
  ...
  <div class="fieldset-content">
    ...
    <table id="invoice-items" class="invoicing-items content-table">
      ...
      <tfoot>
        ...
        <tr>
          ...
          <td headers="invoicing-items-header-unitPrice" class="invoicing-items-unit-price${hasErrors(bean: invoiceInstance, field: 'discountPercent', ' error')}">
        ...
        <tr>
          ...
          <td headers="invoicing-items-header-unitPrice"></td>
          <td headers="invoicing-items-header-total" class="invoicing-items-total${hasErrors(bean: invoiceInstance, field: 'discountAmount', ' error')}">
            <g:textField name="discountAmount" value="${formatNumber(number: invoiceInstance?.discountAmount, minFractionDigits: 2)}" size="8" class="currency" />&nbsp;<g:currency /><br />
        ...
        <tr>
          ...
          <td headers="invoicing-items-header-unitPrice"></td>
          <td headers="invoicing-items-header-total" class="invoicing-items-total${hasErrors(bean: invoiceInstance, field: 'adjustment', ' error')}">
            <g:textField name="adjustment" value="${formatNumber(number: invoiceInstance?.adjustment, minFractionDigits: 2)}" size="8" class="currency" />&nbsp;<g:currency /><br />
      ...
      <tbody>
        <tr>
          ...
          <td headers="invoicing-items-header-unitPrice"></td>
          <td headers="invoicing-items-header-total" class="invoicing-items-total${hasErrors(bean: invoiceInstance, field: 'shippingCosts', ' error')}">
            <g:textField name="shippingCosts" value="${formatNumber(number: invoiceInstance?.shippingCosts, minFractionDigits: 2)}" size="8" class="currency" />&nbsp;<g:currency /><br />
          ...
          <td headers="invoicing-items-header-tax" class="invoicing-items-tax${hasErrors(bean: invoiceInstance, field: 'shippingTax', ' error')}">
    ...
    <g:hasErrors bean="${invoiceInstance}" field="items.*">
      <span class="error-msg"><g:eachError bean="${invoiceInstance}" field="items.*">${it.arguments[0]}: <g:message error="${it}" /> </g:eachError></span>
    </g:hasErrors>
...
(function (window, SPRINGCRM, $) {
    ...
    $("#shippingDate-date").change(function () {
        if ($(this).val() !== "" && $stage.val() < 902) {
            $stage.val(902);
        }
    });
    $("#paymentDate-date").change(function () {
        if ($(this).val() !== "" && $stage.val() < 903) {
            $stage.val(903);
        }
    });
