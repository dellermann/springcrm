    ...
    <div class="col col-l">
      ...
      <div class="row">
        ...
        <div class="field${hasErrors(bean: invoiceInstance, field: 'subject', ' error')}">
          <g:textField name="subject" value="${invoiceInstance?.subject}" size="40" /><br />
      ...
      <div class="row">
        ...
        <div class="field${hasErrors(bean: invoiceInstance, field: 'organization', ' error')}">
          ...
          <input type="hidden" name="organization.id" id="organization-id" value="${invoiceInstance?.organization?.id}" />
