          ...
          <thead>
            <tr>
              <g:sortableColumn property="number"
                title="${message(code: 'organization.number.label')}"/>
              <g:sortableColumn property="name"
                title="${message(code: 'organization.name.label')}"/>
              <th><g:message code="organization.billingAddr.label"/></th>
              <g:sortableColumn property="phone"
                title="${message(code: 'organization.phone.label')}"/>
              <g:sortableColumn property="email1"
                title="${message(code: 'organization.email1.label')}"/>
              <th></th>
            </tr>
          </thead>
          <tbody>
