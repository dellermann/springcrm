      ...
      <div class="table-responsive">
        <table class="table data-table">
          ...
          <g:each in="${dunningInstanceList}" status="i" var="dunningInstance">
            <tr>
              <td class="col-type-id dunning-number"><g:link action="show" id="${dunningInstance.id}"><g:fieldValue bean="${dunningInstance}" field="fullNumber" /></g:link></td>
              <td class="col-type-string dunning-subject"><g:link action="show" id="${dunningInstance.id}"><g:nl2br value="${dunningInstance.subject}" /></g:link></td>
