<fieldset>
  ...
  <div class="multicol-content">
    <div class="col col-l">
      ...
      <div class="row">
        ...
        <div class="field${hasErrors(bean: dunningInstance, field: 'organization', ' error')}">
          <input type="text" id="organization" value="${dunningInstance?.organization?.name}" size="35" />
    ...
    <div class="col col-r">
      ...
      <div class="row">
        <div class="label">
          <label for="paymentDate-date"><g:message code="dunning.paymentDate.label" default="Payment Date" /></label>
        </div>
...
<fieldset>
  ...
  <div class="fieldset-content">
    ...
    <table id="dunning-items" class="invoicing-items content-table">
      <thead>
        <tr>
      ...
      <tfoot>
        <tr>
          <td headers="invoice-items-name" colspan="5" class="invoicing-items-label"><label><g:message code="dunning.subtotalNet.label" default="Subtotal excl. VAT" /></label></td>
        ...
        <tr>
          ...
          <td headers="invoice-items-unitPrice" class="invoicing-items-unit-price${hasErrors(bean: dunningInstance, field: 'discountPercent', ' error')}">
        ...
        <tr>
          ...
          <td headers="invoice-items-unitPrice"></td>
          <td headers="invoice-items-total" class="invoicing-items-total${hasErrors(bean: dunningInstance, field: 'discountAmount', ' error')}">
        ...
        <tr>
          ...
          <td headers="invoice-items-unitPrice"></td>
          <td headers="invoice-items-total" class="invoicing-items-total${hasErrors(bean: dunningInstance, field: 'adjustment', ' error')}">
        ...
        <tr>
          <td headers="invoice-items-name" colspan="5" class="invoicing-items-label"><label><g:message code="dunning.total.label" default="Total" /></label></td>
          <td headers="invoice-items-unitPrice"></td>
      ...
      <tbody>
        <tr>
          ...
          <td headers="invoice-items-unitPrice"></td>
          <td headers="invoice-items-total" class="invoicing-items-total${hasErrors(bean: dunningInstance, field: 'shippingCosts', ' error')}">
          ...
          <td headers="invoice-items-tax" class="invoicing-items-tax${hasErrors(bean: dunningInstance, field: 'shippingTax', ' error')}">
...
(function (window, SPRINGCRM, $) {
    ...
    $("#shippingDate-date").change(function () {
        if ($(this).val() !== "" && $stage.val() < 2202) {
            $stage.val(2202);
        }
    });
    $("#paymentDate-date").change(function () {
        if ($(this).val() !== "" && $stage.val() < 2203) {
            $stage.val(2203);
        }
    });

    $("#dunning-form").submit(function () {
        var newVal,
            oldVal,
            res = true;
