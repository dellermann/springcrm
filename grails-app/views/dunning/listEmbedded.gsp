...
<table class="content-table">
  ...
  <g:each in="${dunningInstanceList}" status="i" var="dunningInstance">
    <tr>
      ...
      <td class="id dunning-number"><g:link controller="dunning" action="show" id="${dunningInstance.id}">${fieldValue(bean: dunningInstance, field: "fullNumber")}</g:link></td>
      <td class="string dunning-subject"><g:link controller="dunning" action="show" id="${dunningInstance.id}">${fieldValue(bean: dunningInstance, field: "subject")}</g:link></td>
