      ...
      <g:each in="${callInstanceList}" status="i" var="callInstance">
        <tr>
          ...
          <td>
            ...
            <g:link action="delete" id="${callInstance?.id}" class="button small red" onclick="return confirm(SPRINGCRM.getMessage('deleteConfirmMsg'));"><g:message code="default.button.delete.label" /></g:link>
          </td>
        </tr>
      </g:each>
      </tbody>
