    ...
    <table class="content-table">
      ...
      <g:each in="${callInstanceList}" status="i" var="callInstance">
        <tr>
          ...
          <td class="string call-subject"><g:link action="show" id="${callInstance.id}">${fieldValue(bean: callInstance, field: "subject")}</g:link></td>
          <g:ifModuleAllowed modules="contact"><td class="ref call-organization"><g:link controller="organization" action="show" id="${callInstance.organization?.id}">${fieldValue(bean: callInstance, field: "organization")}</g:link></td></g:ifModuleAllowed>
