...
<body>
  <div id="main-container-header">
    ...
    <nav id="toolbar-container">
      <ul id="toolbar">
        <li><a href="#" class="green submit-btn" data-form="call-form"><g:message code="default.button.save.label" /></a></li>
  ...
  <section id="content">
    ...
    <h3><g:message code="call.new.label" default="New ${entityName}" /></h3>
    <g:form name="call-form" action="save" params="[returnUrl:params.returnUrl]">
