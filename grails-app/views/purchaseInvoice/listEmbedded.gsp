...
<table class="content-table">
  ...
  <g:each in="${purchaseInvoiceInstanceList}" status="i" var="purchaseInvoiceInstance">
    <tr>
      ...
      <td class="string purchase-invoice-number"><g:link controller="purchaseInvoice" action="show" id="${purchaseInvoiceInstance.id}">${fieldValue(bean: purchaseInvoiceInstance, field: "number")}</g:link></td>
      <td class="string purchase-invoice-subject"><g:link controller="purchaseInvoice" action="show" id="${purchaseInvoiceInstance.id}">${fieldValue(bean: purchaseInvoiceInstance, field: "subject")}</g:link></td>
