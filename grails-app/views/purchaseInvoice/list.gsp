    ...
    <table class="content-table">
      ...
      <g:each in="${purchaseInvoiceInstanceList}" status="i" var="purchaseInvoiceInstance">
        <tr>
          ...
          <td class="content-table-type-string content-table-column-purchase-invoice-number" headers="content-table-headers-purchase-invoice-number"><g:link action="show" id="${purchaseInvoiceInstance.id}">${fieldValue(bean: purchaseInvoiceInstance, field: "number")}</g:link></td>
          <td class="content-table-type-string content-table-column-purchase-invoice-subject" headers="content-table-headers-purchase-invoice-subject"><g:link action="show" id="${purchaseInvoiceInstance.id}">${fieldValue(bean: purchaseInvoiceInstance, field: "subject")}</g:link></td>
          <td class="content-table-type-ref content-table-column-purchase-invoice-vendor" headers="content-table-headers-purchase-invoice-vendor"><g:if test="${purchaseInvoiceInstance?.vendor}"><g:link controller="organization" action="show" id="${purchaseInvoiceInstance?.vendor?.id}">${purchaseInvoiceInstance?.vendorName?.encodeAsHTML()}</g:link></g:if><g:else>${purchaseInvoiceInstance?.vendorName?.encodeAsHTML()}</g:else></td>
