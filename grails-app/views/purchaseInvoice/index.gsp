<html>
  ...
  <body>
    <g:applyLayout name="list" model="[list: purchaseInvoiceInstanceList]">
      <div class="table-responsive">
        <table class="table data-table">
          ...
          <tbody>
            ...
            <tr>
              <td class="col-type-string purchase-invoice-number"><g:link action="show" id="${purchaseInvoiceInstance.id}"><g:fieldValue bean="${purchaseInvoiceInstance}" field="number" /></g:link></td>
              <td class="col-type-string purchase-invoice-subject"><g:link action="show" id="${purchaseInvoiceInstance.id}"><g:fieldValue bean="${purchaseInvoiceInstance}" field="subject" /></g:link></td>
              <td class="col-type-ref purchase-invoice-vendor"><g:if test="${purchaseInvoiceInstance?.vendor}"><g:link controller="organization" action="show" id="${purchaseInvoiceInstance?.vendor?.id}"><g:fieldValue bean="${purchaseInvoiceInstance}" field="vendorName" /></g:link></g:if><g:else><g:fieldValue bean="${purchaseInvoiceInstance}" field="vendorName" /></g:else></td>
              ...
              <td class="col-type-currency purchase-invoice-total"><g:formatCurrency number="${purchaseInvoiceInstance.total}" displayZero="true" external="true" /></td>
              <td class="col-type-currency purchase-invoice-balance balance-state balance-state-${purchaseInvoiceInstance?.balanceColor}"><g:formatCurrency number="${purchaseInvoiceInstance?.balance}" displayZero="true" external="true" /></td>
