...
<table class="content-table">
  ...
  <g:each in="${projectInstanceList}" status="i" var="projectInstance">
    <tr>
      ...
      <td class="content-table-type-id content-table-column-project-number" headers="content-table-headers-project-number"><g:link controller="project" action="show" id="${projectInstance.id}">${fieldValue(bean: projectInstance, field: "fullNumber")}</g:link></td>
      <td class="content-table-type-string content-table-column-project-title" headers="content-table-headers-project-title"><g:link controller="project" action="show" id="${projectInstance.id}">${fieldValue(bean: projectInstance, field: "title")}</g:link></td>
      ...
      <td class="content-table-type-string content-table-column-project-status project-status project-status-${projectInstance.status.id}" headers="content-table-headers-project-status">${fieldValue(bean: projectInstance, field: "status")}</td>
