    ...
    <div class="col col-l">
      <div class="row">
        ...
        <div class="field${hasErrors(bean: productInstance, field: 'number', ' error')}">
          PRD-<g:textField name="number" value="${fieldValue(bean: productInstance, field: 'number')}" size="10" /><br />
      ...
      <div class="row">
        ...
        <div class="field${hasErrors(bean: productInstance, field: 'unitPrice', ' error')}">
          <g:textField name="unitPrice" value="${formatNumber(number: productInstance?.unitPrice, minFractionDigits: 2)}" size="10" /> €<br />
