      ...
      <g:each in="${productInstanceList}" status="i" var="productInstance">
        <tr>
          ...
          <td>
            ...
            <g:link action="delete" id="${productInstance?.id}" class="button small red" onclick="return confirm(springcrm.messages.deleteConfirmMsg);"><g:message code="default.button.delete.label" /></g:link>
          </td>
        </tr>
      </g:each>
      </tbody>
