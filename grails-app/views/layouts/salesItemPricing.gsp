  ...
  <div class="toggle-visibility hidden">
    <p style="display: table;">
      <span style="display: table-row;">
        ...
        <span style="display: table-cell;"><span class="${hasErrors(bean: salesItem.pricing, field: quantity, 'error')}"><input id="step1-pricing-quantity" type="text" name="pricing.quantity" size="6" value="${formatNumber(number: salesItem.pricing?.quantity, maxFractionDigits: 3)}" placeholder="${message(code: 'salesItem.quantity.label', default: 'Quantity')}" /></span>
        <g:select from="${units}" optionKey="id" optionValue="name" id="step1-pricing-unit" name="pricing.unit.id" value="${salesItem.pricing?.unit?.id}" />:</span>
      </span>
      <g:hasErrors bean="${salesItem.pricing}" field="quantity">
      <span style="display: table-row;">
        <span style="display: table-cell;">&nbsp;</span>
        <span class="error-msg" style="display: table-cell;"><g:eachError bean="${salesItem.pricing}" field="quantity"><g:message error="${it}" /> </g:eachError></span>
      </span>
      </g:hasErrors>
    </p>
  ...
  <table id="step2" class="content-table price-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td></td>
        <td></td>
        <td class="percentage number"><input id="step2-discount-percent" type="text" name="pricing.discountPercent" size="5" value="${formatNumber(number: salesItem.pricing?.discountPercent, minFractionDigits: 2)}" class="percent" /></td>
        <td></td>
        <td></td>
      ...
      <tr>
        ...
        <td></td>
        <td></td>
        <td class="currency number"><input id="step2-adjustment" type="text" name="pricing.adjustment" size="8" value="${formatNumber(number: salesItem.pricing?.adjustment, minFractionDigits: 2)}" />&nbsp;<g:currency /></td>
      </tr>
    </tbody>
  </table>
</fieldset>
  ...
  <table id="step3" class="content-table price-table">
    ...
    <tbody>
      <tr>
        ...
        <td class="unit"><f:input bean="${salesItem}" property="unit" id="step3-unit" /></td>
        <td class="unit-price-label"><g:message code="salesItem.pricing.per.label" /></td>
