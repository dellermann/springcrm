  ...
  <div id="main-container-header">
    ...
    <nav id="toolbar-container">
      <ul id="toolbar">
        ...
        <li><g:link action="delete" id="${serviceInstance?.id}" class="red" onclick="return confirm(springcrm.messages.deleteConfirmMsg);"><g:message code="default.button.delete.label" /></g:link></li>
      </ul>
    </nav>
  </div>
  <aside id="action-bar">
