...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.de = {
		...
		messages   : {
			...
			'errJqui'              : 'Ungültige jQuery UI Konfiguration. Die Komponenten selectable, draggable und droppable müssen eingebunden sein.',
			...
			'errConnect'           : 'Verbindung zum Server fehlgeschlagen.',
			'errAbort'             : 'Verbindung abgebrochen.',
			'errTimeout'           : 'Zeitüberschreitung bei der Verbindung.',
			'errNotFound'          : 'Server nicht gefunden.',
			'errResponse'          : 'Ungültige Antwort vom Server.',
			'errConf'              : 'Ungültige Konfiguration auf dem Server.',
			'errJSON'              : 'PHP JSON Modul nicht vorhanden.',
			'errNoVolumes'         : 'Lesbare Datenträger nicht vorhanden.',
			'errCmdParams'         : 'Ungültige Parameter für Befehl: "$1".',
			'errDataNotJSON'       : 'Daten nicht im JSON Format.',
			'errDataEmpty'         : 'Daten sind leer.',
			'errCmdReq'            : 'Server-Anfrage benötigt Befehl.',
			...
			'errLocked'            : '"$1" ist verriegelt und kann nicht umbenannt, verschoben oder gelöscht werden.',
			...
			'errPopup'             : 'Der Browser hat das Pop-Up-Fenster unterbunden. Um die Datei zu öffnen, müssen Pop-Up-Fenster in den Browser-Einstellungen aktiviert werden.',
			...
			'errUploadCommon'      : 'Fehler beim Hochladen.',
			...
			'errUploadTransfer'    : 'Fehler beim Dateitransfer von "$1".',
			...
			'errCmdNoSupport'      : 'Der Server unterstützt diesen Befehl nicht.',
			...
			'ntffile'     : 'Öffne Datei',
			'ntfreload'   : 'Verzeichnisinhalt wird neu geladen',
			...
			'ntfsearch'   : 'Suche',
			'ntfsmth'     : 'Bin beschäftigt. Bitte warten…',
			...
			'help'            : 'Hilfe',
			'webfm'           : 'Web Dateimanager',
			'ver'             : 'Version',
			'protocol'        : 'Protokollversion',
			'homepage'        : 'Projekt-Website',
			'docs'            : 'Dokumentation',
			'github'          : 'Teile uns auf Github',
			...
			'shortcutsof'     : 'Kürzel deaktivieren',
			'dropFiles'       : 'Dateien hier ablegen',
			'or'              : 'oder',
			'selectForUpload' : 'Dateien zum Hochladen auswählen',
			...
			'kindRPM'         : 'RPM Paket',
			// texts
			'kindText'        : 'Textdokument',
			'kindTextPlain'   : 'Textdokument',
