  ...
  InvoicingItemsWidget = {
    ...
    _onClick: function(event) {
      ...
      if ($img.hasClass("select-btn-products")) {
        this._showSalesItemSelector($img, "products");
        return false;
      }
      if ($img.hasClass("select-btn-services")) {
        this._showSalesItemSelector($img, "services");
        return false;
      }
      return true;
    },
    ...
    _onLoadSalesItemSelector: function($dialog, type, pos) {
      ...
      return $dialog.unbind("click").click(function(event) {
        var $target, target;
        target = event.target;
        ...
        if ($target.hasClass("select-link")) {
          _this._retrieveSalesItem(type, $target.attr("href"), pos);
        } else {
          _this._loadSalesItemSelector(type, $target.attr("href"), pos, getData());
        }
        return false;
