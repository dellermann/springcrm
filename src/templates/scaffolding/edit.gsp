...
<body>
  <div id="main-container-header">
    ...
    <nav id="toolbar-container">
      <ul id="toolbar">
        <li><a href="javascript:void 0;" class="green" onclick="springcrm.onClickSubmit('${domainClass.propertyName}-form');"><g:message code="default.button.save.label" /></a></li>
  ...
  <section id="content">
    ...
    <g:form name="${domainClass.propertyName}-form" action="update" method="post" <%= multiPart ? ' enctype="multipart/form-data"' : '' %>>
