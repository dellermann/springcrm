...
<xsl:stylesheet version="1.0"
  ...
  <xsl:import href="/public/print/default/config.xsl"/>
  <xsl:import href="/public/print/default/header.xsl"/>
  <xsl:import href="/public/print/default/footer.xsl"/>
  <xsl:import href="/public/print/default/terms-and-conditions.xsl"/>
  <xsl:import href="/public/print/default/html.xsl"/>
  <xsl:import href="/public/print/default/utilities.xsl"/>
  ...
  <xsl:template name="transaction-specification">
    ...
    <xsl:param name="additional-specifications" select="node()"/>
  ...
  <xsl:template name="header-text">
    ...
    <xsl:param name="additional-text" select="node()"/>
